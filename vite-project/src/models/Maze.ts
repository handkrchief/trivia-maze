...
export default class Maze {
  ...
  public getAdjacentRoom({
    ...
    switch (direction) {
      ...
      case "south":
        return theRow < this.myRooms.length - 1
          ? this.myRooms[theRow + 1][theCol]
          : null;
      case "east":
        return theCol < this.myRooms[0].length - 1
          ? this.myRooms[theRow][theCol + 1]
          : null;
      case "west":
